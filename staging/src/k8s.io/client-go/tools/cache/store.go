...
type TransactionStore interface {
	// Transaction allows multiple operations to occur within a single lock acquisitionAdd commentMore actions
	// to ensure progress can be made when there is contention.
	// A lock-free view of the store is passed to the specified function, and the programmer
	// must not utilize it outside this closure.
